...
template ProposalSubmissionProof(treeLevels) {
    ...
    signal output proposalClaimNullifier; // each accepted proposal can be claimed only once
    ...
    proposalClaimHash.inputs[2] <== proposalSubmissionNullifier; // contains the whole proposal content + context
